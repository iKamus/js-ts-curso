...
1) Crea en la carpeta ejercicios un archivo nuevo llamado `utilidades.cjs`
...
cortas por espacios y cuentas los pedazos
                              (usa split, la herramienta del modulo 06)
3) Al final del archivo exportalas TODAS juntas en un objeto.
   Observa como se exporta en `lib/matematicas.cjs`: module.exports
...
4) Importa el paquete. Observa como se consume en `uso-cjs.cjs`
...
// completa aqui (require + llamadas)

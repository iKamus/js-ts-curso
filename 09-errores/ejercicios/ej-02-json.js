...
Creá parsearJSON(texto). JSON es como un formulario con formato estricto:
comillas dobles, llaves bien puestas, todo en orden. Si el texto no
respeta ese formato, JSON.parse se cae con un SyntaxError. Acá lo atrapás
para que el programa siga de largo en vez de explotar.

Paso a paso:
1) Creá la funcion parsearJSON(texto) que:
...
2) Llamala con dos textos y mostrá los resultados con console.log:
   ...
   o podes guardar el resultado en una variable primero.

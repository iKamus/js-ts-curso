...
funcion que devolve la sigue viendo aunque se mueva de lugar. Es como
...
1) Crear crearContador() que:
   ...
   - devuelva una funcion que: suma 1 a esa variable y devuelve
     el valor acumulado
   La funcion que devolves es la que "captura" la variable cuenta:
   nadie mas la ve, pero ella la maneja. Fijate como esta armado
   en ejemplos/03-closures-currying.js.
...
Tip: la variable cuenta es privada. No podes accederla desde afuera

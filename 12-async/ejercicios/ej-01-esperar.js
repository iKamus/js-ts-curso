...
Paso a paso:
1) Crear esperar(ms) que devuelva una promesa. Fijate como se arma
   en ejemplos/02-promesas.js (la funcion esperar de ese ejemplo):
...
2) Usala con .then (fijate como en el mismo ejemplo):
   .then se ejecuta cuando la promesa se cumple, y recibe el valor
   que paso resolve (acá: 'listo').

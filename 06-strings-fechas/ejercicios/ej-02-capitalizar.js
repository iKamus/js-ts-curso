...
Devolve la frase con cada palabra empezando con mayuscula, como los
...
Capitalizar una palabra = primera letra en mayuscula + el resto igual:
  ...
  ejemplos/01-strings.js tenes las herramientas para agarrar cada
  pedazo: la que te da un caracter en cierta posicion y la que corta
  un pedazo del texto. Tambien la que pone en mayuscula.)

Paso a paso:
1) Separala en palabras. Te queda un array con cada palabra
   suelta (la herramienta de partir esta en el mismo ejemplo).
2) Usa .map() para capitalizar cada palabra. En cada vuelta tenes que:
   - agarrar la primera letra y ponerla en mayuscula
   - juntarla con el resto de la palabra
   - devolver el resultado
3) Volve a juntar las palabras en una sola frase (el metodo que
   vuelve a pegar pedazos esta en el mismo ejemplo).

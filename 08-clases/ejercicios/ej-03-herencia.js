...
2) Crea la clase Auto que HEREDA de Vehiculo:
   ...
   - su constructor recibe (marca, anio, puertas). Primero tiene que
     ...
     como avisar al padre: "che, primero armas tu parte, que yo despues
...
Tip: mira ejemplos/02-herencia.js para ver como funciona extends, super
y override. El orden en el constructor es importante: super() primero,
despues this.

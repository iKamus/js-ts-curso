...
Tienes esta lista de numeros:
  const numeros = [4, 8, 15, 16, 23, 42];
Sumalos y muestra el total.
...
que hay adentro a tu acumulador y sigues, hasta llegar al final.

Paso a paso:
1) Usa numeros.reduce(...) con la flecha de dos parametros que viste
   en el README del modulo (seccion reduce):
   - el acumulador arranca en 0 (ese es el segundo argumento de reduce)
   - en cada vuelta, devuelves el acumulador mas el numero de la vuelta

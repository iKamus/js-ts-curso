...
Crea dividir(a, b). Piensalo como repartir la torta entre personas:
...
Paso a paso:
1) Crea la funcion dividir(a, b) que:
...
2) Llamala DOS veces, cada llamada envuelta en try/catch:
   ...
   - catch(e) es donde atrapas el error y muestras e.message.
   Tip: es como la red de seguridad del trapecista: si te caes,

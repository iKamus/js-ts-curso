...
// OJO: ^ no es potencia en JS. Es XOR, un operador de bits.
// La potencia SIEMPRE es **. Si ponés ^, el resultado no tiene sentido:
...
console.log(5 === '5');  // false (compara valor Y tipo) → USÁ ESTE, el más exigente
